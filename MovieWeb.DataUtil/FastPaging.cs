...
namespace MovieWeb.DataUtil
{
    ...
    public class FastPaging
    {
        ...
        public string Build2000()
        {
            ...
            int pageCount = GetPageCount(this.RecordCount, this.PageSize);   //分页的总数
            //计算中间页的索引
            ...
            {
                sb.Append("SELECT TOP ").Append(this.PageSize).Append(" ").Append(this.QueryFields)
                    .Append(" FROM ").Append(this.TableName);
                if (string.IsNullOrEmpty(this.TableReName) == false)
                {
                    sb.Append(" AS ").Append(this.TableReName);
                }
                if (string.IsNullOrEmpty(this.JoinSQL) == false)
                {
                    sb.Append(" ").Append(this.JoinSQL);
                }
                if (string.IsNullOrEmpty(this.Condition) == false)
                {
                    sb.Append(" WHERE ").Append(this.Condition);
                }
                if (string.IsNullOrEmpty(this.GroupBy) == false)
                {
                    sb.Append(" GROUP BY ");
                    sb.Append(this.GroupBy);
                }
                if (string.IsNullOrEmpty(this.Having) == false)
                {
                    sb.Append(" HAVING ");
                    sb.Append(this.Having);
                }
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ")
                    .Append(GetSortType(this.Ascending));
            }
            #endregion

            #region @FirstIndex < @PageIndex < @LastIndex
            else if (this.PageIndex > firstIndex && this.PageIndex < lastIndex)
            {
                sb.Append(" SELECT TOP ").Append(this.PageSize).Append(" *").Append(" FROM ");
                sb.Append(" (");
                sb.Append(" SELECT TOP ").Append(this.PageSize).Append(" *").Append(" FROM");
                sb.Append(" (");
                sb.Append(" SELECT TOP ").Append(this.PageSize * this.PageIndex).Append(" ").Append(this.QueryFields);
                ...
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ").Append(GetSortType(this.Ascending));
                sb.Append(" ) as TableA");
                sb.Append(" ORDER BY TableA.").Append(this.PrimaryKey).Append(" ").Append(GetSortType(!this.Ascending));
                sb.Append(" ) as TableB");
                sb.Append(" ORDER BY TableB.").Append(this.PrimaryKey).Append(" ").Append(GetSortType(this.Ascending));
            }
            #endregion
            ...
            {
                sb.Append("SELECT TOP ").Append(this.PageSize).Append(" *").Append(" FROM ( SELECT TOP ").Append(this.RecordCount - this.PageSize * (lastIndex - 1))
                    .Append(" ").Append(this.QueryFields)
                    .Append(" FROM ").Append(this.TableName);
                if (string.IsNullOrEmpty(this.TableReName) == false)
                {
                    sb.Append(" AS ").Append(this.TableReName);
                ...
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ")
                    .Append(GetSortType(!this.Ascending))
                    .Append(" ) TableA ORDER BY TableA.").Append(this.PrimaryKey).Append(" ")
                    .Append(GetSortType(this.Ascending));
            }
            #endregion
        ...
        public string Build2005()
        {
            ...
            strSQL.AppendFormat(" FROM {0} AS {1}", this.TableName, this.TableReName);
            if (string.IsNullOrEmpty(this.JoinSQL) == false)
            {
        ...
        public string BuildMySql()
        {
            ...
            if (this.PageIndex <= firstIndex)
            {
                sb.Append("SELECT ").Append(this.QueryFields)
                    .Append(" FROM ").Append(this.TableName);
                if (string.IsNullOrEmpty(this.TableReName) == false)
                {
                    sb.Append(" AS ").Append(this.TableReName);
                ...
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ")
                    .Append(GetSortType(this.Ascending));
                sb.AppendFormat(" limit {0}", this.PageSize);
            }
            #endregion
            ...
            else if (this.PageIndex > firstIndex && this.PageIndex < lastIndex)
            {
                ...
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ").Append(GetSortType(this.Ascending));
                sb.AppendFormat(" limit {0}", this.PageSize * this.PageIndex);
                sb.Append(" ) as TableA");
                sb.Append(" ORDER BY TableA.").Append(this.PrimaryKey).Append(" ").Append(GetSortType(!this.Ascending));
                sb.AppendFormat(" limit {0}", this.PageSize);
                sb.Append(" ) as TableB");
            ...
            {
                sb.Append("SELECT *").Append(" FROM ( SELECT ").Append(this.QueryFields)
                    .Append(" FROM ").Append(this.TableName);
                if (string.IsNullOrEmpty(this.TableReName) == false)
                {
                    sb.Append(" AS ").Append(this.TableReName);
                ...
                sb.Append(" ORDER BY ").Append(string.IsNullOrEmpty(this.TableReName) ? this.TableName : this.TableReName).Append(".").Append(this.PrimaryKey).Append(" ")
                    .Append(GetSortType(!this.Ascending));
                sb.AppendFormat(" limit {0}", this.RecordCount - this.PageSize * (lastIndex - 1));
                sb.Append(" ) TableA ORDER BY TableA.").Append(this.PrimaryKey).Append(" ")
                .Append(GetSortType(this.Ascending));
                sb.AppendFormat(" limit {0}", this.PageSize);
